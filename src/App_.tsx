  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="flex">
        ...
        <main className="ml-64 flex-1 p-8 bg-gray-100 h-100">
            ...
            <>
              ...
              <div className="mt-8 text-center">
                <button
                  ...
                  disabled={loading}
                  className={`bg-pink-500 hover:bg-pink-600 text-white font-semibold py-2 px-6 rounded-lg transition-colors duration-300 ${
